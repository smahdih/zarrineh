(() => {
    ...
    async function _n(e, t) {
        var r;
        t === void 0 && (t = {});
        let { x: n, y: i, platform: o, rects: a, elements: d, strategy: f } = e,
            {
            ...
            S = ei(E),
            I = d[O ? (m === 'floating' ? 'reference' : 'floating') : m],
            $ = Cn(
    ...
    var Vi = function (e) {
            return (
                e === void 0 && (e = 0),
                {
                    ...
                    async fn(t) {
                        var r, n;
                        let { x: i, y: o, placement: a, middlewareData: d } = t,
                            f = await va(t, e);
                        return a ===
    ...
    function Ha(e) {
        ...
        (e.magic('float', (n) => (i = {}, o = {}) => {
            let a = { ...t, ...o },
                d = Object.keys(i).length > 0 ? Na(i) : { middleware: [ii()] },
                f = n,
        ...
        let t = (a) =>
            ...
            i = async (a, d, f = null, u = null) => {
                ...
                let m = document.head,
                    O = null;
                if (f && u) {
                    let E = document.querySelector(`link[href*="${u}"]`);
                    E
                        ? ((m = E.parentElement),
            ...
            o = async (a, d, f = null, u = null, y = null) => {
                let m = document.head,
                    O = null;
                if (f && u) {
        ...
        Lo = function (t) {
            function r(o, a) {
                return function (d, f, u, y) {
                    ...
                    var O = (a ? d : f).options.group.name;
                    return (
                        o === !0 ||
                        (typeof o == 'string' && o === O) ||
                ...
                (t.sortable = Oi.create(t, {
                    ...
                    onEnd(n) {
                        ...
                        let f = this.options.draggable,
                            u = o.querySelectorAll(`:scope > ${f}`)[d - 1];
...
`,
            ...
            function Xt(g) {
                ...
                return {
                    ...
                    arrow: D.find(function (L) {
                        return (
                            L.classList.contains(a) || L.classList.contains(d)
                        );
                    }),
            ...
            function fn(g, w) {
                ...
                if (!D.render)
                    return (
                        zt(!0, 'render() function has not been supplied.'),
                        x
                    );
                var Ge = D.render(x),
                    ce = Ge.popper,
                ...
                function Le() {
                    var C = x.props.appendTo,
                        K,
                        te = lt();
                    ((x.props.interactive && C === Ze.appendTo) ||
                    C === 'parent'
                        ? (K = te.parentNode)
                        : (K = O(C, [te])),
