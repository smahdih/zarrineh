...
function Et(i, t, e) {
    let { reference: s, floating: n } = i,
        o = M(t),
        r = bt(t),
        l = gt(r),
        a = z(t),
        c = o === 'y',
        h = s.x + s.width / 2 - n.width / 2,
...
var Dt = async (i, t, e) => {
    let {
        ...
        c = await r.getElementRects({ reference: i, floating: t, strategy: n }),
        { x: h, y: d } = Et(c, s, a),
        p = s,
        f = {},
        u = 0;
...
async function wt(i, t) {
    var e;
    t === void 0 && (t = {});
    let { x: s, y: n, platform: o, rects: r, elements: l, strategy: a } = i,
        {
        ...
        y = U(
            await o.getClippingRect({
                element:
                    (e = await (o.isElement == null
                        ? void 0
                        : o.isElement(g))) == null || e
                        ? g
                        : g.contextElement ||
        ...
        L = (await (o.isElement == null ? void 0 : o.isElement(v)))
        ...
        x = U(
            o.convertOffsetParentRelativeRectToViewportRelativeRect
                ? await o.convertOffsetParentRelativeRectToViewportRelativeRect(
                      { elements: l, rect: b, offsetParent: v, strategy: a },
                  )
                : b,
        );
    return {
        top: (y.top - x.top + u.top) / L.y,
        bottom: (x.bottom - y.bottom + u.bottom) / L.y,
        left: (y.left - x.left + u.left) / L.x,
        right: (x.right - y.right + u.right) / L.x,
    };
}
var Rt = function (i) {
    return (
        i === void 0 && (i = {}),
        {
            ...
            async fn(t) {
                ...
                let Q = [l, ...x],
                    $ = await wt(t, g),
                    F = [],
                    I = ((s = o.flip) == null ? void 0 : s.overflows) || [];
                if ((h && F.push($[y]), d)) {
                    let A = Ot(n, r, L);
                    F.push($[A[0]], $[A[1]]);
                }
                if (
                    ...
                    if (
                        ...
                        (!(d === 'alignment' ? b !== M(T) : !1) ||
                            I.every(
                                (E) =>
                                    E.overflows[0] > 0 && M(E.placement) === b,
                            ))
                    )
                        return {
                    ...
                    if (n !== W) return { reset: { placement: W } };
                }
                return {};
            },
        }
...
var se = new Set(['left', 'top']);
async function ne(i, t) {
    let { placement: e, platform: s, elements: n } = i,
...
var It = function (i) {
        return (
            i === void 0 && (i = 0),
            {
                ...
                async fn(t) {
                    var e, s;
                    let { x: n, y: o, placement: r, middlewareData: l } = t,
                        a = await ne(t, i);
                    return r ===
                        ((e = l.offset) == null ? void 0 : e.placement) &&
                        (s = l.arrow) != null &&
                        s.alignmentOffset
                        ? {}
                        : {
...
function Pt(i) {
    return ct() ? i instanceof Node || i instanceof O(i).Node : !1;
}
function S(i) {
    return ct() ? i instanceof Element || i instanceof O(i).Element : !1;
}
function R(i) {
    return ct()
        ? i instanceof HTMLElement || i instanceof O(i).HTMLElement
        : !1;
}
function kt(i) {
    return !ct() || typeof ShadowRoot > 'u'
        ? !1
        : i instanceof ShadowRoot || i instanceof O(i).ShadowRoot;
}
var oe = new Set(['inline', 'contents']);
function G(i) {
    let { overflow: t, overflowX: e, overflowY: s, display: n } = C(i);
    return /auto|scroll|overlay|hidden|clip/.test(t + s + e) && !oe.has(n);
}
var re = new Set(['table', 'td', 'th']);
function Mt(i) {
    return re.has(K(i));
}
...
var ae = ['transform', 'translate', 'scale', 'rotate', 'perspective'],
    ce = ['transform', 'translate', 'scale', 'rotate', 'perspective', 'filter'],
...
var he = new Set(['html', 'body', '#document']);
function _(i) {
    return he.has(K(i));
}
function C(i) {
...
function B(i) {
    ...
    let t = i.assignedSlot || i.parentNode || (kt(i) && i.host) || k(i);
...
function at(i, t, e) {
    ...
    let n = Nt(i),
        o = n === ((s = i.ownerDocument) == null ? void 0 : s.body),
        r = O(n);
    if (o) {
        let l = ft(r);
        return t.concat(
...
function X(i) {
    ...
    let e = t.getBoundingClientRect(),
        { width: s, height: n, $: o } = Vt(t),
        r = (o ? et(e.width) : e.width) / s,
        l = (o ? et(e.height) : e.height) / n;
    return (
...
function pe(i, t, e) {
    return (t === void 0 && (t = !1), !e || (t && e !== O(i)) ? !1 : t);
}
function rt(i, t, e, s) {
    ...
    if (o) {
        ...
        for (; m && s && f !== u; ) {
            let g = X(m),
                ...
                b = C(m),
                v = y.left + (m.clientLeft + parseFloat(b.paddingLeft)) * g.x,
                L = y.top + (m.clientTop + parseFloat(b.paddingTop)) * g.y;
            ((a *= g.x),
                (c *= g.y),
                (h *= g.x),
                (d *= g.y),
...
function xt(i, t) {
    let e = ot(i).scrollLeft;
    return t ? t.left + e : rt(k(i)).left + e;
}
function Wt(i, t, e) {
    e === void 0 && (e = !1);
    let s = i.getBoundingClientRect(),
        n = s.left + t.scrollLeft - (e ? 0 : xt(i, s)),
        o = s.top + t.scrollTop;
    return { x: n, y: o };
}
function ue(i) {
    let { elements: t, rect: e, offsetParent: s, strategy: n } = i,
        o = n === 'fixed',
        r = k(s),
        l = t ? nt(t.floating) : !1;
    if (s === r || (l && o)) return e;
    let a = { scrollLeft: 0, scrollTop: 0 },
        ...
        h = D(0),
        d = R(s);
    if ((d || (!d && !o)) && ((K(s) !== 'body' || G(r)) && (a = ot(s)), R(s))) {
        let f = rt(s);
        ((c = X(s)), (h.x = f.x + s.clientLeft), (h.y = f.y + s.clientTop));
    }
    let p = r && !d && !o ? Wt(r, a, !0) : D(0);
    return {
        width: e.width * c.x,
        height: e.height * c.y,
...
function ge(i) {
    let t = k(i),
        ...
        n = V(t.scrollWidth, t.clientWidth, s.scrollWidth, s.clientWidth),
        o = V(t.scrollHeight, t.clientHeight, s.scrollHeight, s.clientHeight),
        r = -e.scrollLeft + xt(i),
        l = -e.scrollTop;
    return (
        C(s).direction === 'rtl' && (r += V(t.clientWidth, s.clientWidth) - n),
...
var we = new Set(['absolute', 'fixed']);
function ye(i, t) {
    let e = rt(i, !0, t === 'fixed'),
        s = e.top + i.clientTop,
        n = e.left + i.clientLeft,
        o = R(i) ? X(i) : D(1),
        r = i.clientWidth * o.x,
        l = i.clientHeight * o.y,
        a = n * o.x,
        c = s * o.y;
...
function Ft(i, t, e) {
    ...
    else if (t === 'document') s = ge(k(i));
    else if (S(t)) s = ye(t, e);
    else {
        let n = $t(i);
...
function Ut(i, t) {
    ...
    return e === t || !S(e) || _(e)
        ? !1
        : C(e).position === 'fixed' || Ut(e, t);
}
function xe(i, t) {
    let e = t.get(i);
    if (e) return e;
    let s = at(i, [], !1).filter((l) => S(l) && K(l) !== 'body'),
        n = null,
        o = C(i).position === 'fixed',
        r = o ? B(i) : i;
    for (; S(r) && !_(r); ) {
        let l = C(r),
            a = dt(r);
...
function ve(i) {
    let { element: t, boundary: e, rootBoundary: s, strategy: n } = i,
        r = [
            ...(e === 'clippingAncestors'
                ? nt(t)
                    ? []
...
function Oe(i, t, e) {
    ...
    if (s || (!s && !o))
        if (((K(t) !== 'body' || G(n)) && (l = ot(t)), s)) {
            let f = rt(t, !0, o, t);
            ((a.x = f.x + t.clientLeft), (a.y = f.y + t.clientTop));
        } else n && c();
    o && !s && n && c();
    let h = n && !s && !o ? Wt(n, l) : D(0),
        d = r.left + l.scrollLeft - a.x - h.x,
        p = r.top + l.scrollTop - a.y - h.y;
    return { x: d, y: p, width: r.width, height: r.height };
}
function yt(i) {
    return C(i).position === 'static';
}
function Ht(i, t) {
    if (!R(i) || C(i).position === 'fixed') return null;
    if (t) return t(i);
    let e = i.offsetParent;
    return (k(i) === e && (e = e.ownerDocument.body), e);
}
function Kt(i, t) {
    let e = O(i);
    if (nt(i)) return e;
...
var Ae = async function (i) {
    let t = this.getOffsetParent || Kt,
        e = this.getDimensions,
        s = await e(i.floating);
    return {
...
var pt = class {
    ...
    renderOptions() {
        ...
        for (let l of e) {
            ...
            if (l.options && Array.isArray(l.options)) {
                ...
                let a = this.createOptionElement(l.value, l);
                (o.appendChild(a), r++, t++);
            }
        }
        t === 0
    ...
    renderOptionGroup(t, e) {
        ...
        ((o.className = 'fi-dropdown-list'),
            e.forEach((r) => {
                let l = this.createOptionElement(r.value, r);
                o.appendChild(l);
            }),
            s.appendChild(n),
            s.appendChild(o),
    ...
    createOptionElement(t, e) {
        ...
        let l = `fi-select-input-option-${Math.random().toString(36).substring(2, 11)}`;
        if (
            ((r.id = l),
            ...
            h.innerHTML = n;
            let d = h.textContent || h.innerText || n;
            r.setAttribute('aria-label', d);
        }
        let a = this.isMultiple
    ...
    async updateSelectedDisplay() {
        if (((this.selectedDisplay.innerHTML = ''), this.isMultiple)) {
            ...
            let e = await this.getLabelsForMultipleSelection();
        ...
        let t = await this.getLabelForSingleSelection();
    ...
    async getLabelsForMultipleSelection() {
        ...
        if (
            ...
            if (Array.isArray(this.initialOptionLabels))
                for (let n of this.initialOptionLabels)
                    w(n) &&
                        n.value !== void 0 &&
                        n.label !== void 0 &&
                        e.includes(n.value) &&
            ...
            try {
                let n = await this.getOptionLabelsUsing();
                for (let o of n)
                    w(o) &&
                        o.value !== void 0 &&
                        o.label !== void 0 &&
    ...
    addBadgesForSelectedOptions(t) {
        ...
        ((e.className = 'fi-select-input-value-badges-ctn'),
            t.forEach((s, n) => {
                let o = Array.isArray(this.state) ? this.state[n] : null,
                    r = this.createBadgeElement(o, s);
                e.appendChild(r);
            }),
            this.selectedDisplay.appendChild(e));
    }
                ...
                ((this.refreshOptionLabelListener = async (t) => {
                    if (
                        ...
                        try {
                            ...
                            let s = this.selectedDisplay.querySelector(
    ...
    updateOptionLabelInList(t, e) {
        ...
        for (let n of this.originalOptions)
            if (n.options && Array.isArray(n.options)) {
                for (let o of n.options)
                    if (o.value === t) {
                        o.label = e;
    ...
    handleSearch(t) {
        ...
        this.searchTimeout = setTimeout(async () => {
            try {
                ...
                let s = await this.getSearchResultsUsing(e);
                ((this.options = s),
    ...
    filterOptions(t) {
        let e = this.searchableOptionFields.includes('label'),
            s = this.searchableOptionFields.includes('value'),
            n = [];
    ...
    selectOption(t) {
        ...
        if (e.includes(t)) {
            let n = this.selectedDisplay.querySelector(`[data-value="${t}"]`);
            if (w(n)) {
        ...
        (N(s) ? this.updateSelectedDisplay() : this.addSingleBadge(t, s),
            this.renderOptions(),
            this.isOpen && this.positionDropdown(),
            this.maintainFocusInMultipleMode(),
            this.onStateChange(this.state));
    ...
    async addSingleBadge(t, e) {
        ...
        N(s) && (s = t);
        let n = this.createBadgeElement(t, s);
        e.appendChild(n);
    }
