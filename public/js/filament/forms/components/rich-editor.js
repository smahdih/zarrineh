...
function Jm(t, e, n, r, o) {
                ...
                D &&
                    !(
                        (ge &&
                            ...
                            (D.head == k || D.head == B.mapping.map(S) - 1)) ||
                        (ke && D.empty && D.head == k)
                    ) &&
                    B.setSelection(D);
            }
    ...
    if (b) {
        if (m.pos == g.pos) {
            ...
            let v = R(t.state.tr);
            (P.type == 'add'
                ? v.addMark(k, S, P.mark)
                : v.removeMark(k, S, P.mark),
                t.dispatch(v));
        } else if (
            ...
            let v = m.parent.textBetween(m.parentOffset, g.parentOffset),
                B = () => R(t.state.tr.insertText(v, k, S));
            t.someProp('handleTextInput', (D) => D(t, k, S, v, B)) ||
                t.dispatch(B());
        }
    } else t.dispatch(R());
}
...
var re;
for (re = 65; re <= 90; re++)
    ((ht[re] = String.fromCharCode(re + 32)),
        (Jr[re] = String.fromCharCode(re)));
var re;
    ...
    if (
        (o.forEach(({ $from: d, $to: f }) => {
            ...
            t.doc.nodesBetween(h, p, (m, g) => {
                ...
                ((s += x),
                    l.push(
                        ...m.marks.map((k) => ({ mark: k, from: y, to: b })),
                    ));
            });
        }),
        s === 0)
    ...
    return (
        n.doc.nodesBetween(r, o, (h, p) => {
            ...
            Rg(y, i.find, s).forEach((x) => {
                ...
                let k = m + x.index + 1,
                    S = k + x[0].length,
                    R = { from: n.tr.mapping.map(k), to: n.tr.mapping.map(S) },
                    P = i.handler({
                        state: n,
                        range: R,
                        match: x,
            ...
            new N({
                ...
                appendTransaction: (d, f, h) => {
                    ...
                    let x = f.doc.content.findDiffStart(h.doc.content),
                        k = f.doc.content.findDiffEnd(h.doc.content);
                    if (!(!Og(x) || !k || x === k.b))
                        return a({
                            rule: u,
                            state: h,
...
var Dy =
        ...
        ({ tr: n, state: r, dispatch: o, editor: i }) => {
            ...
            if (o) {
                let { selection: y, storedMarks: b } = r,
                    ...
                    k = b || (y.$to.parentOffset && y.$from.marks());
                if ((n.split(a.pos, 2, g).scrollIntoView(), !k || !o))
                    return !0;
                let S = k.filter((R) => x.includes(R.type.name));
                n.ensureMarks(S);
            }
            return !0;
        },
    Ps = (t, e) => {
        ...
        return (
            n.node.type === o?.type && Ne(t.doc, n.pos) && t.join(n.pos),
            !0
        );
    },
    Is = (t, e) => {
    ...
    Iy =
        ...
        ({
            ...
            let { extensions: d, splittableMarks: f } = o.extensionManager,
                ...
                { $from: y, $to: b } = m,
                x = y.blockRange(b),
                k = g || (m.$to.parentOffset && m.$from.marks());
            if (!x) return !1;
                ...
                : a()
                      .command(() => {
                          let R = u().wrapInList(h, r),
                              P = k.filter((v) => f.includes(v.type.name));
...
function Qy(t, e) {
    ...
    return (
        i.setSelection(A.near(i.doc.resolve(n.pos + 1))),
        t.dispatch(i),
        !1
    );
}
                ...
                ArrowDown: ({ editor: t }) => {
                    ...
                    return l === void 0
                        ...
                        : r.nodeAt(l)
                          ? t.commands.command(
                                ({ tr: c }) => (
                                    c.setSelection(E.near(r.resolve(l))),
                                    !0
                                ),
                            )
                          : t.commands.exitCode();
...
function J0({ groups: t }) {
    ...
    F(f, t.domain, d);
    let h = Le(Hd);
    (F(f, t.tld, h), F(f, t.utld, h), C(c, ur, h));
    let p = C(d, Be);
    (C(p, Be, p),
        F(p, t.domain, d),
        F(h, t.domain, d),
    ...
    let g = C(s, Be),
        y = C(s, et);
    (C(g, Be, g), F(g, t.domain, s), F(y, r, i), F(y, t.domain, s));
    let b = Le(xo);
    (F(y, t.tld, b),
        F(y, t.utld, b),
        F(b, t.domain, s),
    ...
    let S = Le(xo),
        R = Le();
    (F(S, e, S), F(S, n, R), F(R, e, S), F(R, n, R), C(b, tt, S), C(k, tt, S));
    let P = C(l, Dt),
        v = C(a, Dt),
        B = C(v, tt),
        D = C(B, tt);
    ...
    return (C(o, ur, b), C(o, bl, U0), { start: o, tokens: Kd });
}
function q0(t, e, n) {
    let r = n.length,
        o = 0,
...
function Go(t) {
    return (
        q.initialized || X0(),
        q0(q.parser.start, t, Ud(q.scanner.start, t))
    );
}
Go.scan = Ud;
            ...
            props: {
                handleDrop(s, l) {
                    ...
                    return (
                        a.forEach((u, d) => {
                            ...
                            let f = ('10000000-1000-4000-8000' + -1e11).replace(
                                /[018]/g,
                                (h) =>
                                    (
                                        h ^
                ...
                handlePaste(s, l) {
                    if (
                        ...
                        l.clipboardData?.getData('text').length
                    )
                        return !1;
...
function yb(t) {
    ...
    let x = m + g.index,
        k = x + g[0].length;
    return (
        a && u.test(p.slice(k - 1, k + 1)) && ((g[0] += ' '), (k += 1)),
        x < l.pos && k >= l.pos
            ? {
                  range: { from: x, to: k },
        ...
        b = new N({
            ...
            view() {
                return {
                    update: async (x, k) => {
                        var S, R, P, v, B, D, _;
                        let H = (S = this.key) == null ? void 0 : S.getState(k),
                            j =
                                (R = this.key) == null
                                    ? void 0
                                    : R.getState(x.state),
...
function Fl(t, e) {
    ...
    return (
        e ? e.doc != t.doc && Ef(e.doc, t.doc, 0, r) : t.doc.descendants(r),
        n
    );
}
function Vb(t, e, n, r) {
...
function Gb(t) {
    ...
    if (i == 'row')
        for (let a = 0; a < e.childCount; a++) {
            ...
            ((u || d) && (c = Bl(ye(s).row, new M(c, u, d)).content),
                l.push(c));
        }
...
var ih = (t) => ({
    ...
    async fn(e) {
        ...
        let d = ai(u),
            ...
            k = i.reference[p] + i.reference[h] - f[h] - i.floating[p],
            S = f[h] - i.reference[h],
        ...
        return (
            t === void 0 && (t = {}),
            {
                ...
                async fn(e) {
                    ...
                    let k = [g[Oe(b)], g[x[0]], g[x[1]]],
                        S = [
                            ...(((r = s.autoPlacement) == null
                                ? void 0
                                : r.overflows) || []),
                            { placement: b, overflows: k },
                        ],
                        R = m[y + 1];
                    if (R)
                        return {
            ...
            t === void 0 && (t = {}),
            {
                ...
                async fn(e) {
                    ...
                    let y = Oe(o),
                        b = je(l),
                        x = Oe(l) === l,
                        k = await (a.isRTL == null
                            ? void 0
                            : a.isRTL(c.floating)),
                        S = f || (x || !m ? [pr(l)] : Zf(l)),
                        R = p !== 'none';
                    !f && R && S.push(...eh(l, m, p, k));
                    let P = [l, ...S],
                        v = await en(e, g),
                        B = [],
    ...
    if (i) {
        ...
        for (; m && r && h !== p; ) {
            let g = An(m),
                ...
                k = y.top + (m.clientTop + parseFloat(b.paddingTop)) * g.y;
            ((a *= g.x),
                (c *= g.y),
                (u *= g.x),
                (d *= g.y),
        ...
        render: () => {
            let n,
                ...
                i = () => {
                    ...
                    return (
                        (d.className = 'fi-dropdown-panel fi-dropdown-list'),
                        d
                    );
                },
                s = () => {
...
function sw({
    ...
    return {
        ...
        async init() {
            ((y = new nd({
                ...
                extensions: await Lh({
                    ...
                    insertCustomBlockUsing: (x, k = null) =>
                        this.$wire.mountAction(
                            'customBlock',
                            { id: x, dragPosition: k, mode: 'insert' },
                            { schemaComponent: o },
                        ),
                    key: o,
                    mergeTags: u,
                ...
                Object.keys(g).forEach((x) => {
                    let k = this.$refs[`floatingToolbar::${x}`];
                    if (!k) {
                        console.warn(`Floating toolbar [${x}] not found.`);
                        return;
                    }
                    y.registerPlugin(
                        Yl({
                            editor: y,
                            element: k,
                            pluginKey: `floatingToolbar::${x}`,
                            shouldShow: ({ editor: S }) =>
                                S.isFocused && S.isActive(x),
            ...
            let b = Alpine.debounce(() => this.$wire.commit(), a ?? 300);
            (y.on('update', ({ editor: x }) =>
                this.$nextTick(() => {
                    ((this.editorUpdatedAt = Date.now()),
                        (this.state = x.getJSON()),
                        (this.shouldUpdateState = !1),
                        s && b());
                }),
            ),
                y.on('selectionUpdate', ({ transaction: x }) => {
                    ((this.editorUpdatedAt = Date.now()),
                        (this.editorSelection = x.selection.toJSON()));
                }),
                ...
                window.addEventListener('run-rich-editor-commands', (x) => {
                    x.detail.livewireId === c &&
                        x.detail.key === o &&
                        this.runEditorCommands(x.detail);
                }),
                window.addEventListener('rich-editor-uploading-file', (x) => {
                    x.detail.livewireId === c &&
                        x.detail.key === o &&
                        ((this.isUploadingFile = !0), x.stopPropagation());
                }),
                window.addEventListener('rich-editor-uploaded-file', (x) => {
                    x.detail.livewireId === c &&
                        x.detail.key === o &&
                        ((this.isUploadingFile = !1), x.stopPropagation());
                }),
        ...
        runEditorCommands({ commands: b, editorSelection: x }) {
            ...
            let k = y.chain();
            (b.forEach((S) => (k = k[S.name](...(S.arguments ?? [])))),
                k.run());
        },
        togglePanel(b = null) {
