...
var Jo = (i, t, e) =>
    t in i
        ...
        : (i[t] = e);
var M = (i, t, e) => Jo(i, typeof t != 'symbol' ? t + '' : t, e);
function ye(i) {
    return (i + 0.5) | 0;
}
...
var nt = {
    ...
    Ye = (i) => (i & 240) >> 4 === (i & 15),
    ea = (i) => Ye(i.r) && Ye(i.g) && Ye(i.b) && Ye(i.a);
function ia(i) {
    var t = i.length,
        e;
    return (
...
var _e = class i {
    ...
    greyscale() {
        let t = this._rgb,
            e = ye(t.r * 0.3 + t.g * 0.59 + t.b * 0.11);
...
var kt = class extends it {
    ...
    getLabelAndValue(t) {
        let e = this._cachedMeta,
            s = this.chart,
            n = s.data.labels || [],
            o = se(e._parsed[t], s.options.locale);
...
var $t = class extends it {
    ...
    getLabelAndValue(t) {
        let e = this._cachedMeta,
            s = this.chart,
            n = s.data.labels || [],
            o = se(e._parsed[t].r, s.options.locale);
        return { label: n[t] || '', value: o };
    }
    parseObjectData(t, e, s, n) {
    ...
    ge = class {
        ...
        unregister(t) {
            ...
            (s in e && delete e[s],
                n &&
                    s in V[n] &&
                    (delete V[n][s], this.override && delete Dt[s]));
        }
    };
function Pl(i, t, e) {
    ...
    Pi = class extends st {
        ...
        _draw() {
            let { options: t, columnSizes: e, lineWidths: s, ctx: n } = this,
                { align: o, labels: a } = t,
                r = V.color,
                l = Vt(t.rtl, this.left, this.width),
                c = $(a.font),
                { padding: h } = a,
                d = c.size,
                u = d / 2,
        ...
        drawTitle() {
            let t = this.options,
                ...
                n = q(e.padding);
            if (!e.display) return;
            let o = Vt(t.rtl, this.left, this.width),
                a = this.ctx,
                r = e.position,
                l = s.size / 2,
                c = n.top + l,
...
function Gc(i, t) {
    let e = new Ne({ ctx: i.ctx, options: t, chart: i });
...
var Zc = {
    ...
    Jc = {
        id: 'subtitle',
        start(i, t, e) {
            let s = new Ne({ ctx: i.ctx, options: e, chart: i });
...
function bo(i, t, e, s) {
    let { caretSize: n, caretPadding: o, cornerRadius: a } = i,
        { xAlign: r, yAlign: l } = e,
        c = n + o,
        { topLeft: h, topRight: d, bottomLeft: u, bottomRight: f } = At(a),
        g = sh(t, r),
        p = nh(t, l, c);
    return (
        l === 'center'
...
var Ve = class extends st {
    ...
    update(t, e) {
        ...
        if (!n.length) this.opacity !== 0 && (o = { opacity: 0 });
            ...
            let r = Ee[s.position].call(this, n, this._eventPosition);
    ...
    getCaretPosition(t, e, s) {
        let { xAlign: n, yAlign: o } = this,
            ...
            { topLeft: l, topRight: c, bottomLeft: h, bottomRight: d } = At(r),
            { x: u, y: f } = t,
            { width: g, height: p } = e,
            m,
            b,
    ...
    drawTitle(t, e, s) {
        let n = this.title,
            ...
            l;
        if (o) {
            let c = Vt(s.rtl, this.x, this.width);
            for (
    ...
    drawFooter(t, e, s) {
        let n = this.footer,
            ...
            r;
        if (o) {
            let l = Vt(s.rtl, this.x, this.width);
            for (
...
var He = (i) => Math.floor(xt(i)),
    Nt = (i, t) => Math.pow(10, He(i) + t);
function Mo(i) {
...
function fh(i, { min: t, max: e }) {
    ...
    let s = [],
        ...
        u = J(i.min, Math.round((l + h + d * Math.pow(10, o)) * a) / a);
    for (; u < e; )
...
var ze = class extends Ut {
    ...
    parse(t, e) {
        let s = pe.prototype.parse.apply(this, [t, e]);
        if (s === 0) {
            this._zero = !0;
            return;
        }
