...
var Kc = (s, t, e) =>
    t in s
        ...
        : (s[t] = e);
var S = (s, t, e) => Kc(s, typeof t != 'symbol' ? t + '' : t, e);
function ks(s) {
    return (s + 0.5) | 0;
}
var ee = (s, t, e) => Math.max(Math.min(s, e), t);
function ws(s) {
...
var _t = {
    ...
    En = [...'0123456789ABCDEF'],
    Jc = (s) => En[s & 15],
    Qc = (s) => En[(s & 240) >> 4] + En[s & 15],
    vi = (s) => (s & 240) >> 4 === (s & 15),
    th = (s) => vi(s.r) && vi(s.g) && vi(s.b) && vi(s.a);
function eh(s) {
    var t = s.length,
        e;
    return (
...
var Ss = class s {
    ...
    greyscale() {
        let t = this._rgb,
            e = ks(t.r * 0.3 + t.g * 0.59 + t.b * 0.11);
...
function Wn(s) {
    let t = Math.round(s);
    s = $e(s, t, s / 1e3) ? t : s;
    let e = Math.pow(10, Math.floor(jt(s))),
        i = s / e;
...
var Qr = ['push', 'pop', 'shift', 'splice', 'unshift'];
function ta(s, t) {
    if (s._chartjs) {
...
var zi = (s) => (s === 'start' ? 'left' : s === 'end' ? 'right' : 'center'),
...
function Yn(s, t, e) {
    ...
    if (s._sorted) {
        ...
        if (m) {
            ...
            if (c) {
                let p = l.slice(g - 1).findIndex((y) => !A(y[a.axis]));
                g += Math.max(0, p);
            }
            o = tt(g, n, i) - n;
        } else o = i - n;
...
var Di = (s) => s === 0 || s === 1,
    ...
    Rr = (s, t, e) => Math.pow(2, -10 * s) * Math.sin(((s - t) * j) / e) + 1,
    We = {
        linear: (s) => s,
        easeInQuad: (s) => s * s,
        easeOutQuad: (s) => -s * (s - 2),
...
var Dh = ['x', 'y', 'borderWidth', 'radius', 'tension'],
...
var ia = {
    ...
    logarithmic(s, t, e) {
        if (s === 0) return '0';
        let i = e[t].significand || s / Math.pow(10, Math.floor(jt(s)));
...
function Bi(s, t) {
    let e = {},
        i = L(t),
        n = i ? Object.keys(t) : t,
        o = L(s) ? (i ? (r) => I(s[r], s[t[r]]) : (r) => s[r]) : () => s;
    for (let r of n) e[r] = Bh(o(r));
    return e;
}
function Jn(s) {
...
var Zh = (s, t) => (s === !0 ? t : typeof s == 'string' ? Ut(t, s) : void 0);
function qh(s, t, e, i, n) {
    for (let o of t) {
        let r = Zh(e, o);
        if (r) {
            s.add(r);
            let a = ca(r._fallback, e, n);
...
var Yi = (s) => s.ownerDocument.defaultView.getComputedStyle(s, null);
function nu(s, t) {
    return Yi(s).getPropertyValue(t);
}
var ou = ['top', 'right', 'bottom', 'left'];
function xe(s, t, e) {
    let i = {};
    e = e ? '-' + e : '';
    for (let n = 0; n < 4; n++) {
...
var ru = (s, t, e) => (s > 0 || t > 0) && (!e || !e.shadowRoot);
function au(s, t) {
    let e = s.touches,
        i = e && e.length ? e[0] : s,
...
var Ii = (s) => Math.round(s * 10) / 10;
function fa(s, t, e, i) {
    let n = Yi(s),
        o = xe(n, 'margin'),
        r = Pi(n.maxWidth, s, 'clientWidth') || Ai,
        a = Pi(n.maxHeight, s, 'clientHeight') || Ai,
        l = lu(s, t, e),
        { width: c, height: h } = l;
    if (n.boxSizing === 'content-box') {
        let d = xe(n, 'border', 'width'),
            f = xe(n, 'padding');
...
function ao(s, t, e) {
    ...
    let { property: i, start: n, end: o } = e,
        r = t.length,
        { compare: a, between: l, normalize: c } = ya(i),
        { start: h, end: u, loop: d, style: f } = uu(s, t, e),
        m = [],
        g = !1,
        p = null,
        y,
...
function ka(s, t) {
    ...
    for (let f = 0; f < u; ++f) {
        ...
        let b = d._visualValues || (d._visualValues = {});
        b[a] = p;
    }
}
function uo(s, t) {
...
var fo = (s) => s === 'reset' || s === 'none',
    Ma = (s, t) => (t ? s : Object.assign({}, s)),
    Du = (s, t, e) =>
    ...
    pt = class {
        ...
        linkScales() {
            let t = this.chart,
                ...
                o = (e.xAxisID = I(i.xAxisID, uo(t, 'x'))),
                r = (e.yAxisID = I(i.yAxisID, uo(t, 'y'))),
                a = (e.rAxisID = I(i.rAxisID, uo(t, 'r'))),
                l = e.indexAxis,
        ...
        _resolveElementOptions(t, e = 'default', i) {
            ...
            return (
                g.$shared &&
                    ((g.$shared = l), (o[r] = Object.freeze(Ma(g, l)))),
                g
            );
        }
...
function Nu(s, t, e, i) {
    ...
    let { start: r, end: a, reverse: l, top: c, bottom: h } = Pu(s);
    (n === 'middle' &&
        e &&
    ...
    updateElements(t, e, i, n) {
        ...
        for (let d = e; d < e + i; d++) {
            let f = t[d],
                ...
                y = (g[u] = o ? a.getBasePixel() : a.getPixelForValue(m[u]));
...
var Gt = class extends pt {
    ...
    update(t) {
        let e = this.chart,
            ...
            l = Math.min(Ur(this.options.cutout, a), 1),
            c = this._getRingWeight(this.index),
            { circumference: h, rotation: u } = this._getRotationExtents(),
            { ratioX: d, ratioY: f, offsetX: m, offsetY: g } = zu(u, h, l),
            p = (i.width - r) / d,
            y = (i.height - r) / f,
            b = Math.max(Math.min(p, y) / 2, 0),
            _ = Nn(this.options.radius, b),
            w = Math.max(_ * l, 0),
    ...
    getLabelAndValue(t) {
        let e = this._cachedMeta,
            i = this.chart,
            n = i.data.labels || [],
            o = Ue(e._parsed[t], i.options.locale);
...
var Ke = class extends pt {
    ...
    updateElements(t, e, i, n) {
        let o = n === 'reset',
            ...
            p = we(m) ? m : Number.POSITIVE_INFINITY,
        ...
        for (let x = 0; x < _; ++x) {
            ...
            let v = this.getParsed(x),
                O = A(v[f]),
                E = (M[d] = r.getPixelForValue(v[d], x)),
                C = (M[f] =
                    o || O
                        ? a.getBasePixel()
                        : a.getPixelForValue(
...
var Oe = class extends pt {
    ...
    getLabelAndValue(t) {
        let e = this._cachedMeta,
            i = this.chart,
            n = i.data.labels || [],
            o = Ue(e._parsed[t].r, i.options.locale);
        return { label: n[t] || '', value: o };
    }
    parseObjectData(t, e, i, n) {
...
var Qe = class extends pt {
    ...
    updateElements(t, e, i, n) {
        let o = n === 'reset',
            ...
            y = we(g) ? g : Number.POSITIVE_INFINITY,
        ...
        for (let w = e; w < e + i; ++w) {
            let x = t[w],
                ...
                M = b ? x : {},
                v = A(k[m]),
                O = (M[f] = r.getPixelForValue(k[f], w)),
                E = (M[m] =
                    o || v
                        ? a.getBasePixel()
                        : a.getPixelForValue(
    ...
    if (a && t === a.axis && t !== 'r' && r && o.length) {
        ...
        if (i) {
            ...
            if (l) {
                ...
                h.lo -= Math.max(0, f);
                let m = d.slice(h.hi).findIndex((g) => !A(g[u.axis]));
                h.hi += Math.max(0, m);
            }
            return h;
        }
        ...
        modes: {
            index(s, t, e, i) {
                let n = le(t, s),
                    ...
                    a = e.intersect ? go(s, n, o, i, r) : po(s, n, o, !1, i, r),
                    l = [];
                return a.length
...
function Xu(s, t, e, i) {
    ...
    let a = Math.max(0, t.outerWidth - Ia(r, s, 'left', 'right')),
        l = Math.max(0, t.outerHeight - Ia(r, s, 'top', 'bottom')),
        c = a !== s.w,
        h = l !== s.h;
    return (
        (s.w = a),
...
function nd(s, t, e) {
    let i = s.canvas,
        n = new MutationObserver((o) => {
            let r = !1;
            for (let a of o)
                ((r = r || nn(a.addedNodes, i)),
                    (r = r && !nn(a.removedNodes, i)));
            r && e();
        });
...
var To = class extends sn {
    ...
    addEventListener(t, e, i) {
        ...
        let n = t.$proxies || (t.$proxies = {}),
            r = { attach: nd, detach: od, resize: ld }[e] || cd;
        n[e] = r(t, e, i);
    }
...
function qi(s, t, e, i, n) {
    let o = I(i, 0),
        r = Math.min(I(n, s.length), s.length),
        a = 0,
        l,
        c,
        h;
...
var yd = (s) => (s === 'left' ? 'right' : s === 'right' ? 'left' : s),
    La = (s, t, e) => (t === 'top' || t === 'left' ? s[t] + e : s[t] - e),
    Pa = (s, t) => Math.min(t || s, s);
function Na(s, t) {
    let e = [],
        i = s.length / t,
        n = s.length,
...
var Ee = class s extends yt {
        ...
        getContext(t) {
            ...
            return (
                this.$context ||
                (this.$context = _d(this.chart.getContext(), this))
            );
        }
        _tickSize() {
        ...
        _computeGridLineItems(t) {
            ...
            let gt = I(n.ticks.maxTicksLimit, u),
                H = Math.max(1, Math.ceil(u / gt));
            for (_ = 0; _ < u; _ += H) {
                let Y = this.getContext(_),
                    J = o.setContext(Y),
                    Tt = a.setContext(Y),
                    lt = J.lineWidth,
                    Pe = J.color,
        ...
        _computeLabelItems(t) {
            ...
            if (n === 'top')
                ...
                let H = this._getYAxisLabelAlignment(d);
                ((M = H.textAlign), (x = H.x));
            } else if (n === 'right') {
                let H = this._getYAxisLabelAlignment(d);
                ((M = H.textAlign), (x = H.x));
            ...
            let gt = this._getLabelSizes();
            for (y = 0, b = a.length; y < b; ++y) {
                ((_ = a[y]), (w = _.label));
                let H = o.setContext(this.getContext(y));
                ...
                let Y = C / 2,
                    J = H.color,
                    Tt = H.textStrokeColor,
                    lt = H.textStrokeWidth,
                    Pe = M;
                r
                    ? ((x = v),
                      M === 'inner' &&
    ...
    ss = class {
        ...
        unregister(t) {
            ...
            (i in e && delete e[i],
                n &&
                    i in U[n] &&
                    (delete U[n][i], this.override && delete ne[i]));
        }
    };
function Md(s, t, e) {
    let i = ze(Object.create(null), [e ? U.get(e) : {}, U.get(t), s.defaults]);
    (U.set(t, i),
...
function Pd(s, t) {
    ...
    return (
        Object.keys(i).forEach((r) => {
            ...
            let l = Io(r, a, Ld(r, s), U.scales[a.type]),
                c = Fd(l, n),
                h = e.scales || {};
...
var Ls = (s, t, e) => {
    ...
    Co = class {
        ...
        resolveNamedOptions(t, e, i, n = ['']) {
            let o = { $shared: !0 },
                { resolver: r, subPrefixes: a } = Ha(this._resolverCache, t, n),
                l = r;
            if (Wd(r, e)) {
        ...
        createResolver(t, e, i = [''], n) {
            let { resolver: o } = Ha(this._resolverCache, t, i);
...
var Rd = (s) => L(s) && Object.getOwnPropertyNames(s).some((t) => $t(s[t]));
function Wd(s, t) {
...
var zd = '4.5.0',
    Vd = ['top', 'bottom', 'left', 'right', 'chartArea'];
function Ba(s, t) {
...
function jd(s, t, e) {
    let {
        ...
        u = Math.min(c / r, ot(i - e));
    if ((s.beginPath(), s.arc(n, o, r - c / 2, i + u / 2, e - u / 2), a > 0)) {
        let d = Math.min(c / a, ot(i - e));
        s.arc(n, o, a + c / 2, e - d / 2, i + d / 2, !0);
    } else {
        let d = Math.min(c / 2, r * ot(i - e));
        if (h === 'round') s.arc(n, o, d, e - N / 2, i + N / 2, !0);
        else if (h === 'bevel') {
            let f = 2 * d * d,
                m = -f * Math.cos(e + N / 2) + n,
                g = -f * Math.sin(e + N / 2) + o,
                p = f * Math.cos(i + N / 2) + n,
                y = f * Math.sin(i + N / 2) + o;
...
function Zd(s, t, e, i) {
    let n = Yd(s.options.borderRadius),
        o = (e - t) / 2,
        r = Math.min(o, (i * t) / 2),
        a = (l) => {
...
function on(s, t, e, i, n, o) {
    ...
    let g = Math.max(0.001, m * u - e / N) / u,
        p = (m - g) / 2,
        y = l + p + f,
        b = n - p - f,
        {
    ...
    if ((s.beginPath(), o)) {
        ...
        s.moveTo(r, a);
        let H = Math.cos(O) * u + r,
            Y = Math.sin(O) * u + a;
        s.lineTo(H, Y);
        let J = Math.cos(E) * u + r,
            Tt = Math.sin(E) * u + a;
        s.lineTo(J, Tt);
    }
    s.closePath();
...
var ve = class extends yt {
    ...
    inRange(e, i, n) {
        let o = this.getProps(['x', 'y'], n),
            { angle: r, distance: a } = Hn(o, { x: e, y: i }),
            {
                startAngle: l,
                endAngle: c,
                innerRadius: h,
    ...
    draw(e) {
        ...
        let c = 1 - Math.sin(Math.min(N, n || 0)),
            h = o * c;
...
function Jd(s, t, e, i) {
    let { points: n, options: o } = t,
        { count: r, start: a, loop: l, ilen: c } = El(n, e, i),
        h = Kd(o),
...
function Qd(s, t, e, i) {
    let n = t.points,
        { count: o, start: r, ilen: a } = El(n, e, i),
...
var Vt = class extends yt {
    ...
    interpolate(t, e) {
        let i = this.options,
            n = t[e],
            o = this.points,
            r = lo(this, { property: e, start: n, end: n });
        if (!r.length) return;
        let a = [],
            l = tf(i),
            c,
...
var uf = Object.freeze({
    ...
    qa = Ao.map((s) => s.replace('rgb(', 'rgba(').replace(')', ', 0.5)'));
function Cl(s) {
...
function xf(s, t, e, i, n) {
    ...
    for (r[l++] = s[h], u = 0; u < o - 2; u++) {
        ...
        let k = Math.floor(u * a) + 1 + t,
            M = Math.min(Math.floor((u + 1) * a) + 1, e) + t,
            { x: v, y: O } = s[h];
        for (f = m = -1, b = k; b < M; b++)
            ((m =
                0.5 *
...
function kf(s, t, e) {
    ...
    for (let a of i) {
        ...
        let u = lo(t, h);
        for (let d of u) {
            let f = Lo(e, o[d.start], o[d.end], d.loop),
                m = ao(a, n, f);
            for (let g of m)
                r.push({
                    source: g,
...
function wo(s, t) {
    ...
    for (let { source: c, target: h, start: u, end: d } of l) {
        ...
        (s.save(),
            ...
            Hf(s, r, a, m && Lo(n, u, d)),
            s.beginPath());
        let g = !!e.pathSegment(s, c),
            p;
        if (m) {
            g ? s.closePath() : el(s, i, d, n);
            let y = !!i.pathSegment(s, h, { move: g, reverse: !0 });
            ((p = g && y), p || el(s, i, u, n));
        }
    ...
    an = class extends yt {
        ...
        buildLabels() {
            let t = this.options.labels || {},
                e = B(t.generateLabels, [this.chart], this) || [];
        ...
        fit() {
            ...
            let i = t.labels,
                ...
                { boxWidth: a, itemHeight: l } = sl(i, o),
                c,
                h;
            ((e.font = n.string),
                this.isHorizontal()
        ...
        _fitCols(t, e, i, n) {
            ...
            return (
                this.legendItems.forEach((p, y) => {
                    let { itemWidth: b, itemHeight: _ } = jf(i, e, o, p, n);
                    (y > 0 &&
                        f + _ + 2 * a > h &&
                        ((u += d + a),
        ...
        _draw() {
            let { options: t, columnSizes: e, lineWidths: i, ctx: n } = this,
                { align: o, labels: r } = t,
                a = U.color,
                l = Se(t.rtl, this.left, this.width),
                c = Q(r.font),
                { padding: h } = r,
                u = c.size,
                d = u / 2,
            ...
            (this.drawTitle(),
                ...
                (n.lineWidth = 0.5),
                (n.font = c.string));
            let { boxWidth: m, boxHeight: g, itemHeight: p } = sl(r, u),
                y = function (k, M, v) {
                    if (isNaN(m) || m <= 0 || isNaN(g) || g < 0) return;
                    n.save();
                    let O = I(v.lineWidth, 1);
                    if (
            ...
            (this.legendItems.forEach((k, M) => {
                ...
                let v = n.measureText(k.text).width,
                    O = l.textAlign(k.textAlign || (k.textAlign = r.textAlign)),
                    E = m + d + v,
                    C = f.x,
                    P = f.y;
                (l.setWidth(this.width),
                    _
                        ? M > 0 &&
                          ...
                          f.line++,
                          (C = f.x =
                              rt(o, this.left + h, this.right - i[f.line])))
                        : M > 0 &&
                          P + x > this.bottom &&
        ...
        drawTitle() {
            let t = this.options,
                ...
                n = at(e.padding);
            if (!e.display) return;
            let o = Se(t.rtl, this.left, this.width),
                r = this.ctx,
                a = e.position,
                l = i.size / 2,
                c = n.top + l,
...
var qf = {
        ...
        _element: an,
        start(s, t, e) {
            let i = (s.legend = new an({ ctx: s.ctx, options: e, chart: s }));
    ...
    js = class extends yt {
        ...
        update(t, e) {
            ...
            let o = n * Q(i.font).lineHeight + this._padding.height;
...
function Gf(s, t) {
    let e = new js({ ctx: s.ctx, options: t, chart: s });
...
var Xf = {
    ...
    Kf = {
        id: 'subtitle',
        start(s, t, e) {
            let i = new js({ ctx: s.ctx, options: e, chart: s });
...
function nl(s, t, e) {
    let i = e.yAlign || t.yAlign || Qf(s, e);
...
function ol(s, t, e, i) {
    let { caretSize: n, caretPadding: o, cornerRadius: r } = s,
        { xAlign: a, yAlign: l } = e,
        c = n + o,
        { topLeft: h, topRight: u, bottomLeft: d, bottomRight: f } = ae(r),
        m = sm(t, a),
        g = im(t, l, c);
    return (
        l === 'center'
...
var Bs = class extends yt {
    ...
    getTitle(t, e) {
        let { callbacks: i } = e,
            n = dt(i, 'beforeTitle', this, t),
            o = dt(i, 'title', this, t),
            r = dt(i, 'afterTitle', this, t),
            a = [];
    ...
    getFooter(t, e) {
        let { callbacks: i } = e,
            n = dt(i, 'beforeFooter', this, t),
            o = dt(i, 'footer', this, t),
            r = dt(i, 'afterFooter', this, t),
            a = [];
        return ((a = Wt(a, qt(n))), (a = Wt(a, qt(o))), (a = Wt(a, qt(r))), a);
    }
    _createItems(t) {
    ...
    update(t, e) {
        ...
        if (!n.length) this.opacity !== 0 && (o = { opacity: 0 });
            ...
            let a = Rs[i.position].call(this, n, this._eventPosition);
            ...
            let l = (this._size = il(this, i)),
                c = Object.assign({}, a, l),
                h = nl(this.chart, i, c),
                u = ol(i, c, h, this.chart);
    ...
    getCaretPosition(t, e, i) {
        let { xAlign: n, yAlign: o } = this,
            ...
            { topLeft: l, topRight: c, bottomLeft: h, bottomRight: u } = ae(a),
            { x: d, y: f } = t,
            { width: m, height: g } = e,
            p,
            y,
    ...
    drawTitle(t, e, i) {
        let n = this.title,
            ...
            l;
        if (o) {
            let c = Se(i.rtl, this.x, this.width);
            for (
    ...
    drawFooter(t, e, i) {
        let n = this.footer,
            ...
            a;
        if (o) {
            let l = Se(i.rtl, this.x, this.width);
            for (
    ...
    _updateAnimationTarget(t) {
        let e = this.chart,
            ...
            o = i && i.y;
        if (n || o) {
            let r = Rs[t.position].call(
                this,
                this._active,
                this._eventPosition,
            );
            if (!r) return;
            let a = (this._size = il(this, t)),
...
var cm = (s, t) => (s === null ? null : tt(Math.round(s), 0, t));
function ll(s) {
    let t = this.getLabels();
    return s >= 0 && s < t.length ? t[s] : s;
}
var Ws = class extends Ee {
    constructor(t) {
        (super(t),
...
var Us = (s) => Math.floor(jt(s)),
    Me = (s, t) => Math.pow(10, Us(s) + t);
function hl(s) {
...
function dm(s, { min: t, max: e }) {
    ...
    let i = [],
        ...
        d = ut(s.min, Math.round((l + h + u * Math.pow(10, o)) * r) / r);
    for (; d < e; )
...
var Vs = class extends Ee {
    ...
    parse(t, e) {
        let i = is.prototype.parse.apply(this, [t, e]);
        if (i === 0) {
            this._zero = !0;
            return;
        }
...
function mm(s) {
    ...
    for (let l = 0; l < o; l++) {
        ...
        let h = s.getPointPosition(l, s.drawingArea + n[l], a),
            u = Q(c.font),
            d = fm(s.ctx, u, s._pointLabels[l]);
        i[l] = d;
        let f = ot(s.getIndexAngle(l) + a),
            m = Math.round(Ri(f)),
            g = dl(m, h.x, d.w, 0, 180),
            p = dl(m, h.y, d.h, 90, 270);
        gm(e, t, f, g, p);
    }
...
function bm(s, t, e) {
    let i = [],
        ...
        l = { extra: Po(o) / 2, additionalAngle: r ? N / n : 0 },
        c;
    for (let h = 0; h < n; h++) {
...
function Sm(s, t, e) {
    let { left: i, top: n, right: o, bottom: r } = e,
        { backdropColor: a } = t;
    if (!A(a)) {
        let l = ae(t.borderRadius),
            c = at(t.backdropPadding);
        s.fillStyle = a;
        let h = i - c.left,
            u = n - c.top,
            d = o - i + c.width,
...
var Te = class extends is {
    ...
    setDimensions() {
        let t = (this._padding = at(Po(this.options) / 2)),
    ...
    generateTickLabels(t) {
        (is.prototype.generateTickLabels.call(this, t),
            (this._pointLabels = this.getLabels()
                .map((e, i) => {
                    let n = B(this.options.pointLabels.callback, [e, i], this);
                    return n || n === 0 ? n : '';
                })
    ...
    getIndexAngle(t) {
        let e = j / (this._pointLabels.length || 1),
    ...
    getPointPosition(t, e, i = 0) {
        let n = this.getIndexAngle(t) - X + i;
        return {
...
var De = class extends Ee {
    ...
    init(t, e = {}) {
        let i = t.time || (t.time = {}),
            n = (this._adapter = new No._date(t.adapters.date));
        (n.init(e),
    ...
    _generate() {
        let t = this._adapter,
            ...
            n = this.options,
            o = n.time,
            r = o.unit || gl(o.minUnit, e, i, this._getLabelCapacity(e)),
            a = I(n.ticks.stepSize, 1),
...
var T = 'numeric',
    It = 'short',
    bt = 'long',
    he = { year: T, month: T, day: T },
    Zs = { year: T, month: It, day: T },
    Ro = { year: T, month: It, day: T, weekday: It },
    qs = { year: T, month: bt, day: T },
    Gs = { year: T, month: bt, day: T, weekday: bt },
    Xs = { hour: T, minute: T },
    Ks = { hour: T, minute: T, second: T },
    Js = { hour: T, minute: T, second: T, timeZoneName: It },
    Qs = { hour: T, minute: T, second: T, timeZoneName: bt },
    ti = { hour: T, minute: T, hourCycle: 'h23' },
    ei = { hour: T, minute: T, second: T, hourCycle: 'h23' },
    si = { hour: T, minute: T, second: T, hourCycle: 'h23', timeZoneName: It },
    ii = { hour: T, minute: T, second: T, hourCycle: 'h23', timeZoneName: bt },
    ni = { year: T, month: T, day: T, hour: T, minute: T },
    oi = { year: T, month: T, day: T, hour: T, minute: T, second: T },
    ri = { year: T, month: It, day: T, hour: T, minute: T },
    ai = { year: T, month: It, day: T, hour: T, minute: T, second: T },
    Wo = { year: T, month: It, day: T, weekday: It, hour: T, minute: T },
    li = { year: T, month: bt, day: T, hour: T, minute: T, timeZoneName: It },
    ci = {
        year: T,
        month: bt,
        day: T,
...
var Cm = { year: 0, month: 1, day: 2, era: 3, hour: 4, minute: 5, second: 6 };
function Fm(s, t) {
...
var Vo = new Map(),
    ht = class s extends mt {
        ...
        offset(t) {
            ...
            let i = Im(this.name),
                [n, o, r, a, l, c, h] = i.formatToParts ? Am(i, e) : Fm(i, e);
            a === 'BC' && (n = -Math.abs(n) + 1);
            let d = os({
                    year: n,
                    month: o,
...
var qo = class {
        ...
        format(t) {
            if (this.inf) {
                ...
                let e = this.floor ? Math.floor(t) : rs(t, 3);
    ...
    Hl = { firstDay: 1, minimalDays: 4, weekend: [6, 7] },
    W = class s {
        static fromOpts(t) {
            return s.create(
                t.locale,
        ...
        static create(t, e, i, n, o = !1) {
            let r = t || R.defaultLocale,
                a = r || (o ? 'en-US' : Rm()),
                l = e || R.defaultNumberingSystem,
                c = i || R.defaultOutputCalendar,
                h = fi(n) || R.defaultWeekSettings;
...
var ec = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334],
    sc = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335];
function Mt(s, t) {
    return new st(
        'unit out of range',
...
function oc(s, t = 4, e = 1) {
    let i = gi(s.weekYear),
        n = xt(s.weekNumber, 1, Ce(s.weekYear, t, e)),
        o = xt(s.weekday, 1, 7);
    return i
        ? n
            ? o
...
function rc(s) {
    let t = gi(s.year),
        e = xt(s.ordinal, 1, fe(s.year));
    return t ? (e ? !1 : Mt('ordinal', s.ordinal)) : Mt('year', s.year);
}
function lr(s) {
    let t = gi(s.year),
        e = xt(s.month, 1, 12),
        i = xt(s.day, 1, ls(s.year, s.month));
    return t
        ? e
            ? i
                ? !1
    ...
    it = class s {
        ...
        formatDateTimeFromString(t, e) {
            let i = this.loc.listingMode() === 'en',
                ...
                h = (f) => {
                    let m = s.macroTokenToFormatOpts(f);
                    return m ? this.formatWithSystemDefault(t, m) : f;
                },
                u = (f) => (i ? mc(t, f) : o({ era: f }, 'era')),
                d = (f) => {
                    switch (f) {
                        case 'S':
...
var xc = /(?:([Zz])|([+-]\d\d)(?::?(\d\d))?)/,
    Qm = `(?:${xc.source}?(?:\\[(${yc.source})\\])?)?`,
    gr = /(\d\d)(?::?(\d\d)(?::?(\d\d)(?:[.,](\d{1,30}))?)?)?/,
    _c = RegExp(`${gr.source}${Qm}`),
    pr = RegExp(`(?:[Tt]${_c.source})?`),
    tg = /([+-]\d{6}|\d{4})(?:-?(\d\d)(?:-?(\d\d))?)?/,
    eg = /(\d{4})-?W(\d\d)(?:-?(\d))?/,
    sg = /(\d{4})-?(\d{3})/,
    ig = bc('weekYear', 'weekNumber', 'weekDay'),
    ng = bc('year', 'ordinal'),
    og = /(\d{4})-(\d\d)-(\d\d)/,
    wc = RegExp(`${gr.source} ?(?:${xc.source}|(${yc.source}))?`),
    rg = RegExp(`(?: ${wc.source})?`);
function hs(s, t, e) {
    let i = s[t];
    return D(i) ? e : Kt(i);
...
function xi(s, t) {
    let e = !s[t] && !s[t + 1],
        i = Ie(s[t + 1], s[t + 2]),
        n = e ? null : et.instance(i);
    return [{}, n, t + 3];
}
function _i(s, t) {
    let e = s[t] ? ht.create(s[t]) : null;
    return [{}, e, t + 1];
}
var lg = RegExp(`^T?${gr.source}$`),
    cg =
...
function Ac(s, t) {
    ...
    for (let i of Fg.slice(1)) t[i] && (e += t[i] * s[i].milliseconds);
    return e;
}
function Ic(s, t) {
    let e = Ac(s, t) < 0 ? -1 : 1;
...
var G = class s {
    ...
    static invalid(t, e = null) {
        ...
        let i = t instanceof st ? t : new st(t, e);
    ...
    mapUnits(t) {
        if (!this.isValid) return this;
        let e = {};
        for (let i of Object.keys(this.values)) e[i] = ur(t(this.values[i], i));
    ...
    set(t) {
        if (!this.isValid) return this;
        let e = { ...this.values, ...cs(t, s.normalizeUnit) };
    ...
    rescale() {
        if (!this.isValid) return this;
        let t = Cc(this.normalize().shiftToAll().toObject());
    ...
    equals(t) {
        ...
        for (let i of Ae) if (!e(this.values[i], t.values[i])) return !1;
        return !0;
    }
};
var ps = 'Invalid Interval';
function Ag(s, t) {
    return !s || !s.isValid
...
var te = class {
    static hasDST(t = R.defaultZone) {
        let e = F.now().setZone(t).set({ month: 12 });
...
var Pg = 'missing Intl.DateTimeFormat.formatToParts support';
function z(s, t = (e) => e) {
...
function Yg(s, t) {
    ...
    let e = it.macroTokenToFormatOpts(s.val),
        i = wr(e, t);
...
var wi = class {
    constructor(t, e) {
        if (
            ...
            let [i, n] = Bg(this.units);
            ((this.regex = RegExp(i, 'i')), (this.handlers = n));
        }
    }
    explainFromTokens(t) {
        if (this.isValid) {
            let [e, i] = $g(t, this.regex, this.handlers),
                [n, o, r] = i ? jg(i) : [null, null, void 0];
            if (me(i, 'a') && me(i, 'H'))
                throw new Dt(
...
function wr(s, t) {
    if (!s) return null;
    let i = it.create(t, s).dtFormatter(Ug()),
        n = i.formatToParts(),
        o = i.resolvedOptions();
    return n.map((r) => Hg(r, s, o));
}
var Sr = 'Invalid DateTime',
    Hc = 864e13;
function Si(s) {
...
function bs(s, t, e, i, n, o) {
    ...
    if ((s && Object.keys(s).length !== 0) || t) {
        let l = t || a,
            c = F.fromObject(s, { ...e, zone: l, specificOffset: o });
...
var Gc = { month: 1, day: 1, hour: 0, minute: 0, second: 0, millisecond: 0 },
    Zg = {
        weekNumber: 1,
        weekday: 1,
        hour: 0,
    ...
    qg = { ordinal: 1, hour: 0, minute: 0, second: 0, millisecond: 0 },
...
function Uc(s, t) {
    let e = Ct(t.zone, R.defaultZone);
    if (!e.isValid) return F.invalid(Si(e));
    let i = W.fromObject(t),
        n,
        o;
    if (D(s.year)) n = R.now();
    else {
        for (let l of vn) D(s[l]) && (s[l] = Gc[l]);
        let r = lr(s) || cr(s);
...
var ki,
    ...
    F = class s {
        constructor(t) {
            ...
            if (!i)
                if (t.old && t.old.ts === this.ts && t.old.zone.equals(e))
                    ...
                    let a = Ft(t.o) && !t.old ? t.o : e.offset(this.ts);
                    ((n = Sn(this.ts, a)),
                        (i = Number.isNaN(n.year)
                            ? new st('invalid input')
                            : null),
                        (n = i ? null : n),
                        (o = i ? null : a));
                }
        ...
        static fromJSDate(t, e = {}) {
            let i = lc(t) ? t.valueOf() : NaN;
            if (Number.isNaN(i)) return s.invalid('invalid input');
            let n = Ct(e.zone, R.defaultZone);
            return n.isValid
        ...
        static fromObject(t, e = {}) {
            t = t || {};
            let i = Ct(e.zone, R.defaultZone);
            if (!i.isValid) return s.invalid(Si(i));
            let n = W.fromObject(e),
                o = cs(t, jc),
                { minDaysInFirstWeek: r, startOfWeek: a } = ar(o, n),
                l = R.now(),
            ...
            let w = g ? oc(o, r, a) : h ? rc(o) : lr(o),
                x = w || cr(o);
            if (x) return s.invalid(x);
            let k = g ? or(o, r, a) : h ? rr(o) : o,
                [M, v] = Mn(k, c, i),
                O = new s({ ts: M, zone: i, o: v, loc: n });
        ...
        set(t) {
            if (!this.isValid) return this;
            let e = cs(t, jc),
                { minDaysInFirstWeek: i, startOfWeek: n } = ar(e, this.loc),
        ...
        minus(t) {
            if (!this.isValid) return this;
            let e = G.fromDurationLike(t).negate();
            return Le(this, Bc(this, e));
        }
...
function On({ cachedData: s, options: t, type: e }) {
    return {
        ...
        initChart(i = null) {
            var r, a, l, c, h, u, d, f, m, g, p, y, b, _;
            if (
                !this.$refs.canvas ||
