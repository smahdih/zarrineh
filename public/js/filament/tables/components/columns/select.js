...
async function wt(i, t) {
    ...
    let { x: s, y: n, platform: o, rects: r, elements: l, strategy: a } = i,
        ...
        p = Ct(f),
        g = l[u ? (d === 'floating' ? 'reference' : 'floating') : d],
        y = U(
        ...
        O = (await (o.isElement == null ? void 0 : o.isElement(v)))
        ...
        i === void 0 && (i = {}),
        {
            ...
            async fn(t) {
                ...
                let G = [l, ...x],
                    W = await wt(t, g),
                    L = [],
                    S = ((s = o.flip) == null ? void 0 : s.overflows) || [];
                if ((h && L.push(W[y]), d)) {
                    let D = Ot(n, r, O);
                    L.push(W[D[0]], W[D[1]]);
                }
                if (
                    ...
                    var H, X;
                    let D =
                            (((H = o.flip) == null ? void 0 : H.index) || 0) +
                            1,
                        J = G[D];
                    if (
                        J &&
...
function j(i) {
    let { overflow: t, overflowX: e, overflowY: s, display: n } = E(i);
...
function N(i) {
    ...
    let t = i.assignedSlot || i.parentNode || (kt(i) && i.host) || P(i);
    ...
    if (o) {
        ...
        for (; m && s && f !== p; ) {
            let g = Y(m),
                ...
                O = y.top + (m.clientTop + parseFloat(b.paddingTop)) * g.y;
            ((a *= g.x),
                (c *= g.y),
                (h *= g.x),
                (d *= g.y),
...
function ge(i) {
    let t = P(i),
        ...
        o = $(t.scrollHeight, t.clientHeight, s.scrollHeight, s.clientHeight),
        r = -e.scrollLeft + xt(i),
        l = -e.scrollTop;
    return (
...
function Oe(i, t, e) {
    ...
    o && !s && n && c();
    let h = n && !s && !o ? Wt(n, l) : T(0),
        d = r.left + l.scrollLeft - a.x - h.x,
        u = r.top + l.scrollTop - a.y - h.y;
        ...
        init() {
            (h ||
                ...
                this.$watch('state', async (L) => {
                    ...
                    this.isLoading = !0;
                    let H = await this.$wire.updateTableColumnState(
                        f,
                        v,
                        this.state,
                    );
