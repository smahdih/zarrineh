(() => {
    var ee = Object.create,
        ...
        se = (r) => q(r, '__esModule', { value: !0 }),
        ae = (r, n) => () => (
            n || ((n = { exports: {} }), r(n.exports, n)),
            n.exports
        ),
        oe = (r, n, s) => {
            if ((n && typeof n == 'object') || typeof n == 'function')
                for (let l of ne(n))
                    !re.call(r, l) &&
                        ...
                        q(r, l, {
                            get: () => n[l],
                            enumerable: !(s = ie(n, l)) || s.enumerable,
                        });
            return r;
        },
        fe = (r) =>
        ...
        le = ae((r, n) => {
            (function (s, l, g) {
                ...
                for (
                    ...
                    d[111 + y] = 'f' + y;
                for (y = 0; y <= 9; ++y) d[y + 96] = y.toString();
                function S(e, t, a) {
                ...
                function v(e) {
                    var t = this;
                    if (((e = e || l), !(t instanceof v))) return new v(e);
                    ...
                    function I(i, f, p, o, c, m) {
                        var u,
                            _,
                            M = [],
                            O = p.type;
                        if (!t._callbacks[i]) return [];
                        for (
                            O == 'keyup' && C(i) && (f = [i]), u = 0;
                            u < t._callbacks[i].length;
                            ++u
                        )
                            if (
                                ((_ = t._callbacks[i][u]),
                                !(!o && _.seq && a[_.seq] != _.level) &&
                                    O == _.action &&
                                    ((O == 'keypress' &&
                                        !p.metaKey &&
                                        !p.ctrlKey) ||
                                ...
                                var Z = !o && _.combo == c,
                                    $ = o && _.seq == o && _.level == m;
                                ((Z || $) && t._callbacks[i].splice(u, 1),
                                    M.push(_));
                            }
                        return M;
                    }
                    function L(i, f, p, o) {
                        t.stopCallback(f, f.target || f.srcElement, p, o) ||
                            (i(f, p) === !1 && (H(f), F(f)));
                    }
                    t._handleKey = function (i, f, p) {
                        var o = I(i, f, p),
                            c,
                            m = {},
                            u = 0,
                        ...
                        for (c = 0; c < o.length; ++c)
                            o[c].seq && (u = Math.max(u, o[c].level));
                        for (c = 0; c < o.length; ++c) {
                            if (o[c].seq) {
                                if (o[c].level != u) continue;
                                ((_ = !0),
                                    (m[o[c].seq] = 1),
                                    L(o[c].callback, p, o[c].combo, o[c].seq));
                                continue;
                            }
                            _ || L(o[c].callback, p, o[c].combo);
                        }
                        var M = p.type == 'keypress' && A;
                        (p.type == D && !C(i) && !M && E(m),
                            (A = _ && p.type == 'keydown'));
                    };
                    function K(i) {
                    ...
                    function Q(i, f, p, o) {
                        ...
                        for (var u = 0; u < f.length; ++u) {
                            var _ = u + 1 === f.length,
                                M = _ ? m : c(o || T(f[u + 1]).action);
                            z(f[u], M, o, i, u);
                        }
                    }
                    function z(i, f, p, o, c) {
                        ((t._directMap[i + ':' + p] = f),
                            (i = i.replace(/\s+/g, ' ')));
                        var m = i.split(' '),
                            u;
                        ...
                        ((u = T(i, p)),
                            (t._callbacks[u.key] = t._callbacks[u.key] || []),
                            I(u.key, u.modifiers, { type: u.action }, o, i, c),
                            t._callbacks[u.key][o ? 'unshift' : 'push']({
                                callback: f,
                    ...
                    ((t._bindMultiple = function (i, f, p) {
                        for (var o = 0; o < i.length; ++o) z(i[o], f, p);
                    }),
                        S(e, 'keypress', K),
                        S(e, 'keydown', K),
                        S(e, 'keyup', K));
    ...
    (function (r) {
        if (r) {
            var n = {},
                s = r.prototype.stopCallback;
            ((r.prototype.stopCallback = function (l, g, d, w) {
                var b = this;
                return b.paused ? !0 : n[d] || n[w] ? !1 : s.call(b, l, g, d);
            }),
                (r.prototype.bindGlobal = function (l, g, d) {
                    var w = this;
                    if ((w.bind(l, g, d), l instanceof Array)) {
                        for (var b = 0; b < l.length; b++) n[l[b]] = !0;
                        return;
                    }
                    n[l] = !0;
                }),
    ...
    var ue = (r) => {
            r.directive(
                'mousetrap',
                (n, { modifiers: s, expression: l }, { evaluate: g }) => {
                    let d = () => (l ? g(l) : n.click());
                    ((s = s.map((w) =>
                        w
                            .replace(/--/g, ' ')
                        ...
                        s.includes('global') &&
                            ((s = s.filter((w) => w !== 'global')),
                            R.default.bindGlobal(s, (w) => {
                                (w.preventDefault(), d());
                            })),
                        R.default.bind(s, (w) => {
                            (w.preventDefault(), d());
    ...
    var j = () => ({
        ...
        setUpResizeObserver() {
            ...
            ((this.resizeObserver = new ResizeObserver(() => {
                ...
                (s && l
                    ...
                    : !s && g && (this.isOpen = this.isOpenDesktop),
                    (r = n));
            })),
        ...
        groupIsCollapsed(r) {
            return this.collapsedGroups.includes(r);
        },
        collapseGroup(r) {
            this.collapsedGroups.includes(r) ||
                (this.collapsedGroups = this.collapsedGroups.concat(r));
        },
        toggleCollapsedGroup(r) {
            this.collapsedGroups = this.collapsedGroups.includes(r)
                ? this.collapsedGroups.filter((n) => n !== r)
                : this.collapsedGroups.concat(r);
        },
        close() {
            ((this.isOpen = !1),
    ...
    document.addEventListener('DOMContentLoaded', () => {
        setTimeout(() => {
            ...
            n && n.scrollTo(0, r.offsetTop - window.innerHeight / 2);
        }, 10);
    });
    window.setUpUnsavedDataChangesAlert = ({
        ...
        window.addEventListener('beforeunload', (l) => {
            window.jsMd5(JSON.stringify(s.data).replace(/\\/g, '')) ===
                s.savedDataHash ||
                s?.__instance?.effects?.redirect ||
    ...
    window.setUpSpaModeUnsavedDataChangesAlert = ({
        ...
        let l = () =>
            ...
            g = () => confirm(r);
        (document.addEventListener('livewire:navigate', (d) => {
            if (typeof n() < 'u') {
                if (!l() || g()) return;
                d.preventDefault();
            }
            ...
            window.addEventListener('beforeunload', (d) => {
                l() && (d.preventDefault(), (d.returnValue = !0));
            }));
    };
    window.setUpUnsavedActionChangesAlert = ({
        resolveLivewireComponentUsing: r,
        $wire: n,
    }) => {
