...
return [
    ...
    */
    ...
    'local_sites_path' => env(
        'DEBUGBAR_LOCAL_SITES_PATH',
        env('IGNITION_LOCAL_SITES_PATH'),
    ),
    ...
    'collectors' => [
        ...
        'views' => env('DEBUGBAR_COLLECTORS_VIEWS', default: false), // Views with their data
    ...
    'options' => [
        ...
        'views' => [
            ...
            'inertia_pages' => env(
                'DEBUGBAR_OPTIONS_VIEWS_INERTIA_PAGES',
                'js/Pages',
